...
#  Portions (C) 2014 Bitcraze AB
#
#  Crazyflie Address Configuration Utility
#
#  Based on https://github.com/bitcraze/crazyflie-lib-python/blob/0.1.17.1/examples/memory/write-eeprom.py
#
#
...
class EEPROMExample:
    """
    Lists EEPROMs and writes default values.
    """
